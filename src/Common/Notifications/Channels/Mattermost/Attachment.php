...
class Attachment
{
    ...
    /**
     * A hex color code that will be used as the left border color for the attachment. If not specified, it will
     * default to match the left hand sidebar header background color.
     *
     * @var string
     */
    public $color;
     ...
     * If it includes more than 700 characters or more than 5 line breaks, the message will be collapsed and a “Show
     * More” link will be added to expand the message.
     *
     * @var string
     */
    public $text;
    ...
    /**
     * An optional name used to identify the author. It will be included in a small section at the top of the
     * attachment.
     *
     * @var string
     */
     ...
     * the right side of an attachment. We recommend using an image that is already 75x75 pixels, but larger images
     * will be scaled down with the aspect ratio maintained.
     *
     * @var string
     */
    public $thumbUrl;
     ...
     * @param bool $short   Optionally set to “True” or “False” to indicate whether the value is short enough to be
     *                      displayed beside other values.
     *
     * @return $this
     */
